...
export default function LoginPage() {
  ...
  useEffect(() => {
    window.TelegramLoginCallback = (data: any) => {
      telegramLogin({
        variables: {
    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-background rounded-2xl border border-border shadow-lg p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-[#2AABEE] hover:bg-[#229ED9] text-white font-semibold py-3 px-6 rounded-xl transition-colors"
        >
          🔵 Telegram orqali kirish (test)
        </button>
        ...
        <button className="w-full flex items-center justify-center gap-3 bg-background hover:bg-muted border border-border font-semibold py-3 px-6 rounded-xl transition-colors">
