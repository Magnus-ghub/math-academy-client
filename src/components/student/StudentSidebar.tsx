...
import {
  LayoutDashboard, BookOpen, Trophy, BarChart3, Users, User, Flag, CreditCard, Wallet,
  ChevronRight, Menu, X,
} from "lucide-react";
...
const menuItems = [
  ...
  { href: "/dashboard/balance", icon: Wallet, label: "Balansim" },
  { href: "/dashboard/payments", icon: CreditCard, label: "To'lovlarim" },
