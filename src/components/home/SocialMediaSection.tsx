          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4">
            {socials.map((s) => (
              <a
                ...
                className="group flex flex-col items-center text-center gap-2 sm:gap-3 bg-background rounded-2xl border border-border p-3 sm:p-6 hover:shadow-md hover:-translate-y-0.5 transition-all"
              >
                <div
                ...
                <div>
                  <p className="font-semibold text-xs sm:text-sm">{s.name}</p>
                  <p className="text-xs text-muted-foreground hidden sm:block">{s.handle}</p>
                </div>
                <span className="hidden sm:flex items-center gap-1 text-xs font-medium text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                  Ochish
